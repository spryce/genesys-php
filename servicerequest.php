...
<form name="contactform" onSubmit="return validate_service_request(this);" action="forms/formdata.php" method="post">	
	...
	<table border="0" cellpadding="8" cellspacing="8" summary="contact form">
		...
		<tr>
			...
			<td><select name="subject" id="subject" onchange="gotourl(this.value)">
				...
				<option selected value="servicerequest.php">Service request</option>
				</select>
			</td>
		</tr>
		<tr>
